...
An Arduino core for the ATmega328, ATmega168, ATmega88, ATmega48 and ATmega8, all running the default arduino bootloader obtined arduino ide.
This core requires at least Arduino IDE v1.8, where v1.8.9 or newer is recommended. IDE 2.x should also work.

*The ProMiniCore uses the Optiboot bootloader. It's smaller, faster.
The Version-1.0.0 has fixed Baud rate/ Upload speed of 57600 and cannot be modified for now for system stability,The Atmega 328A/P/PB processor can read and write to EEPROM. 
*
...
* **[Getting started with ProMiniCore](#getting-started-with-prominicore)**
...
|-------------|-----------------------------|---------------------------------------------------------------|
| 16 MHz      | External crystal/oscillator | Default clock on most AVR-based Arduino boards and ProMiniCore   |
...
## Bootloader option
ProMiniCore lets you select which serial port you want to use for uploading. UART0 is the default port for all targets, but ATmega328PB can also use UART1.
...
* Scroll down until you see the **ProMiniCore** entry and click on it.
* Click **Install**.
...
Open Arduino IDE, and a new category in the boards menu called "ProMiniCore" will show up.

#### PlatformIO
[PlatformIO](http://platformio.org) is an open-source ecosystem for IoT and embedded systems, and supports ProMiniCore.

**See [PlatformIO.md]() for more information.*


## Getting started with ProMiniCore
...
* Open the **Tools > Board** menu item, select **ProMiniCore** and select your preferred target.
